...
async function seed() {
  ...
  const kyle = await prisma.user.create({ data: { name: "Kostya", email: "Kostya@Kostya" } })
  const sally = await prisma.user.create({ data: { name: "Kristina", email: "Kristina@kristina" } })
