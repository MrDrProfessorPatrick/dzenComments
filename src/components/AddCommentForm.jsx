      ...
      <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <img
              src="/captchaBg.png"
              className="h-12 w-auto object-cover opacity-0.95"
              alt="captcha"
            />
          ...
          <button
            ...
            className="w-8 h-8 bg-green-500 border border-green-600 flex items-center justify-center text-white hover:bg-green-600 hover:scale-110 transition duration-200 ease-in-out cursor-pointer"
          >
            <FaUndoAlt />
          </button>
          <input
        ...
        <div className="flex items-center gap-3">
          <label htmlFor={`inputFile${parentId}`} className="border">
            Chose file
          </label>
